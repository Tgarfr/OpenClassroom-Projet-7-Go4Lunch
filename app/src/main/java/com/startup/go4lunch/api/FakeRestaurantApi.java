...
public class FakeRestaurantApi implements RestaurantApi {
    ...
    public MutableLiveData<List<Restaurant>> getRestaurantListLiveData(@NonNull Location location) {
        return restaurantListLiveData;
    }

    public static final List<Restaurant> FAKE_RESTAURANTS_LIST = Arrays.asList(
